...
Warning: If you never have been used the extrafont package, the first time that you use the FMap function, 
         the packages will be installed, after that the Microsoft fonts will be imported to R and this prompt 
         message will apprear:
